...
client
  ...
  .setProject("674a8b2c000123456789"); // Replace with your actual project ID

export const account = new Account(client);
export const databases = new Databases(client);

// Database and Collection IDs - Replace with your actual IDs
export const DATABASE_ID = "habit-tracker-db";
export const HABITS_COLLECTION_ID = "habits";
export const COMPLETIONS_COLLECTION_ID = "habit-completions";
